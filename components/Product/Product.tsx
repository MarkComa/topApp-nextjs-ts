...
export const Product = ({
	...
	return (
		<Card className={s.product} {...props}>
			...
			<div className={s.feature}>{product.characteristics && product.characteristics.map(el => {
				return (
					<div className={s.characteristics} key={el.name}>
						<span className={s.characteristicsName}>{el.name}</span>
